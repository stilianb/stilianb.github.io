...
function DefaultCard(props) {
  return (
    <div className={`${props.card === "default" ? "opacity-0" : "opacity-100"} absolute flex flex-col w-full h-full justify-center bg-crust rounded-md p-2 `}>
      <div className="w-fit mx-auto p-2 flex flex-col gap-3 ">
        <div className="">
          <h2 className="ml-1 text-subtext0 text-2xl">Hi, I'm</h2>
          <h1 className="text-4xl">Stilian Balasopoulov</h1>
